...
namespace Formatter
{
    class Program
    {
        ...
        {
            string url = "http://st-takla.org/pub_Bible-Interpretations/Holy-Bible-Tafsir-01-Old-Testament/Father-Antonious-Fekry/01-Sefr-El-Takween/Tafseer-Sefr-El-Takwin__01-Chapter-01.html";
